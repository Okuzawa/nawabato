(self["webpackChunknawabato"]=self["webpackChunknawabato"]||[]).push([[998],{4444:function(e,t,n){"use strict";n.d(t,{BH:function(){return C},G6:function(){return v},L:function(){return a},LL:function(){return O},Pz:function(){return A},Sg:function(){return x},UG:function(){return f},ZB:function(){return u},ZR:function(){return D},aH:function(){return k},b$:function(){return g},eu:function(){return w},hl:function(){return _},jU:function(){return p},m9:function(){return K},ne:function(){return B},pd:function(){return q},r3:function(){return L},ru:function(){return m},tV:function(){return c},uI:function(){return d},vZ:function(){return F},w1:function(){return y},xO:function(){return U},xb:function(){return M},z$:function(){return h},zd:function(){return j}});
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Jt(e,t,n){const r=(0,i.m9)(e),s={requestType:"EMAIL_SIGNIN",email:t};T(n.handleCodeInApp,r,"argument-error"),n&&Bt(r,s,n),await We(r,s)}function Yt(e,t){const n=lt.parseLink(t);return"EMAIL_SIGNIN"===(null===n||void 0===n?void 0:n.operation)}async function Xt(e,t,n){const r=(0,i.m9)(e),s=ht.credentialWithLink(t,n||x());return T(s._tenantId===(r.tenantId||null),r,"tenant-id-mismatch"),Lt(r,s)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sh{constructor(e,t,n,r,i){this.localStore=e,this.datastore=t,this.asyncQueue=n,this.remoteSyncer={},this.fu=[],this.du=new Map,this._u=new Set,this.wu=[],this.mu=i,this.mu.Ur((e=>{n.enqueueAndForget((async()=>{Ph(this)&&(Pr("RemoteStore","Restarting streams for network reachability change."),await async function(e){const t=qr(e);t._u.add(4),await Ah(t),t.gu.set("Unknown"),t._u.delete(4),await kh(t)}(this))}))})),this.gu=new Eh(n,r)}}async function kh(e){if(Ph(e))for(const t of e.wu)await t(!0)}async function Ah(e){for(const t of e.wu)await t(!1)}function Ch(e,t){const n=qr(e);n.du.has(t.targetId)||(n.du.set(t.targetId,t),Rh(n)?Oh(n):Xh(n).ko()&&Nh(n,t))}function xh(e,t){const n=qr(e),r=Xh(n);n.du.delete(t),r.ko()&&Dh(n,t),0===n.du.size&&(r.ko()?r.Fo():Ph(n)&&n.gu.set("Unknown"))}function Nh(e,t){e.yu.Ot(t.targetId),Xh(e).zo(t)}function Dh(e,t){e.yu.Ot(t),Xh(e).Ho(t)}function Oh(e){e.yu=new Da({getRemoteKeysForTarget:t=>e.remoteSyncer.getRemoteKeysForTarget(t),ne:t=>e.du.get(t)||null}),Xh(e).start(),e.gu.uu()}function Rh(e){return Ph(e)&&!Xh(e).No()&&e.du.size>0}function Ph(e){return 0===qr(e)._u.size}function Lh(e){e.yu=void 0}async function Mh(e){e.du.forEach(((t,n)=>{Nh(e,t)}))}async function Fh(e,t){Lh(e),Rh(e)?(e.gu.hu(t),Oh(e)):e.gu.set("Unknown")}async function Vh(e,t,n){if(e.gu.set("Online"),t instanceof xa&&2===t.state&&t.cause)try{await async function(e,t){const n=t.cause;for(const r of t.targetIds)e.du.has(r)&&(await e.remoteSyncer.rejectListen(r,n),e.du.delete(r),e.yu.removeTarget(r))}(e,t)}catch(n){Pr("RemoteStore","Failed to remove targets %s: %s ",t.targetIds.join(","),n),await Uh(e,n)}else if(t instanceof Aa?e.yu.Kt(t):t instanceof Ca?e.yu.Jt(t):e.yu.jt(t),!n.isEqual(si.min()))try{const t=await $l(e.localStore);n.compareTo(t)>=0&&await function(e,t){const n=e.yu.Zt(t);return n.targetChanges.forEach(((n,r)=>{if(n.resumeToken.approximateByteSize()>0){const i=e.du.get(r);i&&e.du.set(r,i.withResumeToken(n.resumeToken,t))}})),n.targetMismatches.forEach((t=>{const n=e.du.get(t);if(!n)return;e.du.set(t,n.withResumeToken(zi.EMPTY_BYTE_STRING,n.snapshotVersion)),Dh(e,t);const r=new Wc(n.target,t,1,n.sequenceNumber);Nh(e,r)})),e.remoteSyncer.applyRemoteEvent(n)}(e,n)}catch(t){Pr("RemoteStore","Failed to raise snapshot:",t),await Uh(e,t)}}async function Uh(e,t,n){if(!Ci(t))throw t;e._u.add(1),await Ah(e),e.gu.set("Offline"),n||(n=()=>$l(e.localStore)),e.asyncQueue.enqueueRetryable((async()=>{Pr("RemoteStore","Retrying IndexedDB access"),await n(),e._u.delete(1),await kh(e)}))}function jh(e,t){return t().catch((n=>Uh(e,n,t)))}async function qh(e){const t=qr(e),n=Zh(t);let r=t.fu.length>0?t.fu[t.fu.length-1].batchId:-1;for(;Bh(t);)try{const e=await Kl(t.localStore,r);if(null===e){0===t.fu.length&&n.Fo();break}r=e.batchId,$h(t,e)}catch(e){await Uh(t,e)}Gh(t)&&zh(t)}function Bh(e){return Ph(e)&&e.fu.length<10}function $h(e,t){e.fu.push(t);const n=Zh(e);n.ko()&&n.Yo&&n.Xo(t.mutations)}function Gh(e){return Ph(e)&&!Zh(e).No()&&e.fu.length>0}function zh(e){Zh(e).start()}async function Kh(e){Zh(e).eu()}async function Hh(e){const t=Zh(e);for(const n of e.fu)t.Xo(n.mutations)}async function Wh(e,t,n){const r=e.fu.shift(),i=Kc.from(r,t,n);await jh(e,(()=>e.remoteSyncer.applySuccessfulWrite(i))),await qh(e)}async function Qh(e,t){t&&Zh(e).Yo&&await async function(e,t){if(n=t.code,ua(n)&&n!==Br.ABORTED){const n=e.fu.shift();Zh(e).Mo(),await jh(e,(()=>e.remoteSyncer.rejectFailedWrite(n.batchId,t))),await qh(e)}var n}(e,t),Gh(e)&&zh(e)}async function Jh(e,t){const n=qr(e);n.asyncQueue.verifyOperationInProgress(),Pr("RemoteStore","RemoteStore received new credentials");const r=Ph(n);n._u.add(3),await Ah(n),r&&n.gu.set("Unknown"),await n.remoteSyncer.handleCredentialChange(t),n._u.delete(3),await kh(n)}async function Yh(e,t){const n=qr(e);t?(n._u.delete(2),await kh(n)):t||(n._u.add(2),await Ah(n),n.gu.set("Unknown"))}function Xh(e){return e.pu||(e.pu=function(e,t,n){const r=qr(e);return r.su(),new bh(t,r.connection,r.authCredentials,r.appCheckCredentials,r.yt,n)
/**
 * @license
 * Copyright 2018 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */}(e.datastore,e.asyncQueue,{Yr:Mh.bind(null,e),Zr:Fh.bind(null,e),Wo:Vh.bind(null,e)}),e.wu.push((async t=>{t?(e.pu.Mo(),Rh(e)?Oh(e):e.gu.set("Unknown")):(await e.pu.stop(),Lh(e))}))),e.pu}function Zh(e){return e.Iu||(e.Iu=function(e,t,n){const r=qr(e);return r.su(),new Ih(t,r.connection,r.authCredentials,r.appCheckCredentials,r.yt,n)}(e.datastore,e.asyncQueue,{Yr:Kh.bind(null,e),Zr:Qh.bind(null,e),tu:Hh.bind(null,e),Zo:Wh.bind(null,e)}),e.wu.push((async t=>{t?(e.Iu.Mo(),await qh(e)):(await e.Iu.stop(),e.fu.length>0&&(Pr("RemoteStore",`Stopping write stream with ${e.fu.length} pending writes`),e.fu=[]))}))),e.Iu
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */}class ed{constructor(e,t,n,r,i){this.asyncQueue=e,this.timerId=t,this.targetTimeMs=n,this.op=r,this.removalCallback=i,this.deferred=new Gr,this.then=this.deferred.promise.then.bind(this.deferred.promise),this.deferred.promise.catch((e=>{}))}static createAndSchedule(e,t,n,r,i){const s=Date.now()+n,o=new ed(e,t,s,r,i);return o.start(n),o}start(e){this.timerHandle=setTimeout((()=>this.handleDelayElapsed()),e)}skipDelay(){return this.handleDelayElapsed()}cancel(e){null!==this.timerHandle&&(this.clearTimeout(),this.deferred.reject(new $r(Br.CANCELLED,"Operation cancelled"+(e?": "+e:""))))}handleDelayElapsed(){this.asyncQueue.enqueueAndForget((()=>null!==this.timerHandle?(this.clearTimeout(),this.op().then((e=>this.deferred.resolve(e)))):Promise.resolve()))}clearTimeout(){null!==this.timerHandle&&(this.removalCallback(this),clearTimeout(this.timerHandle),this.timerHandle=null)}}function td(e,t){if(Lr("AsyncQueue",`${t}: ${e}`),Ci(e))return new $r(Br.UNAVAILABLE,`${t}: ${e}`);throw e}
/**
 * @license
 * Copyright 2017 Google LLC
 *
...
//# sourceMappingURL=chunk-vendors.4e52155a.js.map