"use strict";(self["webpackChunktest_project"]=self["webpackChunktest_project"]||[]).push([[443],{2991:function(e,t,n){n.r(t),n.d(t,{default:function(){return Gk}});var r={};n.r(r),n.d(r,{FirebaseError:function(){return B},SDK_VERSION:function(){return Nt},_DEFAULT_ENTRY_NAME:function(){return yt},_addComponent:function(){return bt},_addOrOverwriteComponent:function(){return _t},_apps:function(){return wt},_clearComponents:function(){return kt},_components:function(){return It},_getProvider:function(){return Et},_registerComponent:function(){return Tt},_removeServiceInstance:function(){return St},deleteApp:function(){return Pt},getApp:function(){return xt},getApps:function(){return Ot},initializeApp:function(){return Rt},onLog:function(){return Mt},registerVersion:function(){return Lt},setLogLevel:function(){return Ft}});var i=n(6252),s=n(9963),o=n(3577);const a={class:"about"},c={id:"app"},u=(0,i._)("label",null,"名前",-1),l=(0,i._)("label",null,"メッセージ",-1),h={style:{"margin-left":"100px"}};function d(e,t,n,r,d,f){return(0,i.wg)(),(0,i.iD)("div",a,[(0,i._)("div",c,[u,(0,i.wy)((0,i._)("input",{type:"text","onUpdate:modelValue":t[0]||(t[0]=e=>d.userName=e)},null,512),[[s.nr,d.userName]]),l,(0,i.wy)((0,i._)("input",{type:"text","onUpdate:modelValue":t[1]||(t[1]=e=>d.message=e)},null,512),[[s.nr,d.message]]),(0,i._)("button",{onClick:t[2]||(t[2]=(...e)=>f.sendMessage&&f.sendMessage(...e))},"送信"),(0,i._)("ul",null,[((0,i.wg)(!0),(0,i.iD)(i.HY,null,(0,i.Ko)(d.messageList,((e,t,n)=>((0,i.wg)(),(0,i.iD)("li",{key:n},[(0,i.Uk)((0,o.zw)(e.user_name)+" ",1),(0,i._)("span",h,(0,o.zw)(e.message),1)])))),128))])])])}n(7658);
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function xi(e){var t;const n=Ur(e);if(await n._initializationPromise,null===(t=n.currentUser)||void 0===t?void 0:t.isAnonymous)return new Ni({user:n.currentUser,providerId:null,operationType:"signIn"});const r=await Di(n,{returnSecureToken:!0}),i=await Ni._fromIdTokenResponse(n,"signIn",r,!0);return await n._updateCurrentUser(i.user),i}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dc=500;class Nc{constructor(){this._redirectPersistence=Us,this._shouldInitProactively=!0,this.eventManagers=new Map,this.originValidationPromises={},this._completeRedirectFn=pa,this._overrideRedirectResult=ia}async _initialize(e){const t=e._key();let n=this.eventManagers.get(t);return n||(n=new vc(e),this.eventManagers.set(t,n),this.attachCallbackListeners(e,n)),n}_openPopup(e){En(e,"operation-not-supported-in-this-environment")}async _openRedirect(e,t,n,r){pc(e);const i=await this._initialize(e);await i.initialized(),i.resetRedirect(),ra(),await this._originValidation(e);const s=wc(e,n,r);await Ic(e,s);const o=await lc(e,s,t),a=await dc(o);return fc(e,i,a)}_isIframeWebStorageSupported(e,t){throw new Error("Method not implemented.")}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=hc(e)),this.originValidationPromises[t]}attachCallbackListeners(e,t){const{universalLinks:n,handleOpenURL:r,BuildInfo:i}=cc(),s=setTimeout((async()=>{await bc(e),t.onEvent(xc())}),Dc),o=async n=>{clearTimeout(s);const r=await bc(e);let i=null;r&&(null===n||void 0===n?void 0:n["url"])&&(i=_c(r,n["url"])),t.onEvent(i||xc())};"undefined"!==typeof n&&"function"===typeof n.subscribe&&n.subscribe(null,o);const a=r,c=`${i.packageName.toLowerCase()}://`;cc().handleOpenURL=async e=>{if(e.toLowerCase().startsWith(c)&&o({url:e}),"function"===typeof a)try{a(e)}catch(t){console.error(t)}}}}const Rc=Nc;function xc(){return{type:"unknown",eventId:null,sessionId:null,urlResponse:null,postBody:null,tenantId:null,error:Sn("no-auth-event")}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
const wu=Dn;class Iu{constructor(e,t,n=hn.app()){var r;wu(null===(r=n.options)||void 0===r?void 0:r.apiKey,"invalid-api-key",{appName:n.name}),this._delegate=new xo(e,t,n.auth()),this.type=this._delegate.type}clear(){this._delegate.clear()}render(){return this._delegate.render()}verify(){return this._delegate.verify()}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Nb(){return"undefined"!=typeof window?window:null}function Rb(){return"undefined"!=typeof document?document:null}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vk(e){Fk(e,((e,t)=>new yk(e,t,new gk))),e.registerVersion(ck,uk)}let Uk;Vk(hn);var qk={name:"app",data(){return{messageList:[],userName:"ユーザーA",message:"テストメッセージです"}},created:function(){var e={apiKey:"AIzaSyArEFrBMUMDHAYTjFJ2HhsHb__zIPYMfLc",authDomain:"turf-war-ebf17.firebaseapp.com",projectId:"turf-war-ebf17",storageBucket:"turf-war-ebf17.appspot.com",messagingSenderId:"1096461103992",appId:"1:1096461103992:web:57b6f83644c9882d8d8e8d"};hn.initializeApp(e);const t=hn.firestore();Uk=t.collection("chat_messages");let n=this.messageList;Uk.orderBy("created","desc").onSnapshot((function(e){n.length=0,e.forEach((e=>{n.push(e.data())}))}))},methods:{sendMessage:function(){Uk.add({user_name:this.userName,message:this.message,created:(new Date).getTime()})}}},Bk=n(3744);const jk=(0,Bk.Z)(qk,[["render",d]]);var Gk=jk},3847:function(e,t,n){n.r(t),n.d(t,{default:function(){return O}});var r=n(6252);const i={class:"post"};function s(e,t,n,s,o,a){const c=(0,r.up)("HelloWorld"),u=(0,r.up)("DeckInfo"),l=(0,r.up)("CardList");return(0,r.wg)(),(0,r.iD)("div",i,[(0,r.Wm)(c,{class:"text",msg:"デッキ名"}),(0,r.Wm)(u,{class:"list",deck:this.myDeck},null,8,["deck"]),(0,r.Wm)(c,{class:"text",msg:"カード一覧"}),(0,r.Wm)(l,{class:"list"})])}n(7658);const o={class:"container"};function a(e,t,n,i,s,a){const c=(0,r.up)("CardItem");return(0,r.wg)(),(0,r.iD)("div",o,[((0,r.wg)(!0),(0,r.iD)(r.HY,null,(0,r.Ko)(this.$store.state.cardList,((e,t,n)=>((0,r.wg)(),(0,r.iD)("div",{key:n},[(0,r.Wm)(c,{name:e.name,count:e.count,cost:e.cost,map:e.map,block:this.$store.state.blocks[1],sp_block:this.$store.state.blocks[2]},null,8,["name","count","cost","map","block","sp_block"])])))),128))])}var c=n(3577);const u=e=>((0,r.dD)("data-v-71658665"),e=e(),(0,r.Cn)(),e),l={class:"CardItem"},h={class:"card-item btn btn-secondary"},d={ref:"cardCanvas"},f={class:"name"},p={class:"count"},m=u((()=>(0,r._)("p",{class:"sp"},"消費SP",-1))),g={class:"cost"};function y(e,t,n,i,s,o){return(0,r.wg)(),(0,r.iD)("div",l,[(0,r._)("button",h,[(0,r._)("canvas",d,null,512),(0,r._)("p",f,(0,c.zw)(n.name),1),(0,r._)("div",p,[(0,r._)("p",null,(0,c.zw)(n.count),1)]),(0,r._)("div",null,[m,(0,r._)("p",g,(0,c.zw)(n.cost),1)])])])}var v={name:"CardItem",props:{name:String,count:Number,cost:Number,map:Array,block:String,sp_block:String},data(){return{ctx:null}},mounted(){this.ctx=this.$refs.cardCanvas.getContext("2d"),this.imageDraw(this.map)},methods:{imageDraw:function(e){let t=0;for(let n=0;n<8;n++)for(let r=0;r<8;r++){let i=new Image;switch(e[t]){case 0:i.src=this.$store.state.blocks[0];break;case 1:i.src=this.block;break;case 2:i.src=this.sp_block;break;default:break}i.onload=()=>{this.ctx.drawImage(i,36*r+6,18*n+3,36,18)},t++}}}},w=n(3744);const I=(0,w.Z)(v,[["render",y],["__scopeId","data-v-71658665"]]);var b=I,_={name:"CardListView",components:{CardItem:b},data(){return{}},created:function(){}};const T=(0,w.Z)(_,[["render",a],["__scopeId","data-v-e93c6a7a"]]);var E=T;const S={class:"container"};function k(e,t,n,i,s,o){const a=(0,r.up)("CardItem");return(0,r.wg)(),(0,r.iD)("div",S,[((0,r.wg)(!0),(0,r.iD)(r.HY,null,(0,r.Ko)(s.cardList,((e,t,n)=>((0,r.wg)(),(0,r.iD)("div",{key:n},[(0,r.Wm)(a,{name:e.name,count:e.count,cost:e.cost,map:e.map,block:this.$store.state.blocks[1],sp_block:this.$store.state.blocks[2]},null,8,["name","count","cost","map","block","sp_block"])])))),128))])}var A={name:"CardListView",components:{CardItem:b},props:{deck:Array},data(){return{cardList:[]}},mounted(){this.loadDeck(this.deck)},methods:{loadDeck:function(e){this.cardList=e}}};const C=(0,w.Z)(A,[["render",k],["__scopeId","data-v-974a22a4"]]);var D=C,N=n(8994),R={components:{HelloWorld:N.Z,CardList:E,DeckInfo:D},data(){return{myDeck:[]}},mounted(){this.loadDeck()},methods:{loadDeck:function(){var e=[3,9,12,15,18,21,24,27,30,22,33,11,44,1,5];for(let t=0;t<e.length;t++)this.myDeck.push(this.$store.state.cardList[e[t]])}}};const x=(0,w.Z)(R,[["render",s]]);var O=x}}]);
//# sourceMappingURL=about.f6008bfc.js.map