 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const da=new Gs(li.comparator);function fa(){return da}const pa=new Gs(li.comparator);function ma(...e){let t=pa;for(const n of e)t=t.insert(n.key,n);return t}function ga(e){let t=pa;return e.forEach(((e,n)=>t=t.insert(e,n.overlayedDocument))),t}function ya(){return wa()}function va(){return wa()}function wa(){return new ha((e=>e.toString()),((e,t)=>e.isEqual(t)))}const _a=new Gs(li.comparator),ba=new Hs(li.comparator);function Ia(...e){let t=ba;for(const n of e)t=t.add(n);return t}const Ta=new Hs(ti);function Ea(){return Ta}
/**
 * @license
 * Copyright 2017 Google LLC
 *
...
//# sourceMappingURL=chunk-vendors.7dcc91c3.js.map