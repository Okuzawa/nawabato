 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vk(e){Fk(e,((e,t)=>new yk(e,t,new gk))),e.registerVersion(ck,uk)}let Uk;Vk(hn);var qk={name:"app",data(){return{messageList:[],userName:"ユーザーA",message:"テストメッセージです"}},created:function(){var e={apiKey:"AIzaSyArEFrBMUMDHAYTjFJ2HhsHb__zIPYMfLc",authDomain:"turf-war-ebf17.firebaseapp.com",projectId:"turf-war-ebf17",storageBucket:"turf-war-ebf17.appspot.com",messagingSenderId:"1096461103992",appId:"1:1096461103992:web:57b6f83644c9882d8d8e8d"};hn.initializeApp(e);const t=hn.firestore();Uk=t.collection("chat_messages");let n=this.messageList;Uk.orderBy("created","desc").onSnapshot((function(e){n.length=0,e.forEach((e=>{n.push(e.data())}))}))},methods:{sendMessage:function(){Uk.add({user_name:this.userName,message:this.message,created:(new Date).getTime()})}}},Bk=n(3744);const jk=(0,Bk.Z)(qk,[["render",d]]);var Gk=jk},4744:function(e,t,n){"use strict";n.r(t),n.d(t,{default:function(){return d}});var r=n(6252);const i={class:"post"},s=(0,r._)("h1",null,"This is a post page",-1),o=(0,r._)("button",{class:"btn btn-primary"},"bootstrap-btn",-1),a=[s,o];function c(e,t){return(0,r.wg)(),(0,r.iD)("div",i,a)}var u=n(3744);const l={},h=(0,u.Z)(l,[["render",c]]);var d=h}}]);
//# sourceMappingURL=about.cb6ff727.js.map